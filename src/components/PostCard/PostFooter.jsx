/* @source src/components/PostCard/PostFooter.jsx */
    ...
    return (
        <div className="post-footer-actions">
            ...
            <div className="post-footer-right">
                {ctrl.localPost.dominantEmoji && (
                    <span className="post-captured-badge" title="Эмоджи, которое чаще всего ставило лайки этому посту">
                        <span className="captured-emoji">{ctrl.localPost.dominantEmoji}</span>
                        <span className="captured-text">Пост захвачен</span>
                    </span>
                )}
