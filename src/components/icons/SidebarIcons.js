...
import { Home, History, MusicNote, CompassBig, Bell, User, Download, BookmarkSquareMinimalistic } from "@solar-icons/react";
...
export const IconHistory = (props) => <IconWrapper IconComponent={History} size={26} {...props} />;
