/* @source src/components/icons/VerifyIcons.js */
import React from 'react';

const VerifiedBadge = ({ size = 20, className, color = "#1d9bf0", style, ...props }) => (
    <svg 
        width={size} 
        height={size} 
        viewBox="0 0 26 26" 
